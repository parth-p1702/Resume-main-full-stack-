        ...
        <Paper className="resume-container" elevation={2} style={customStyle}>
          <Box sx={{ flexShrink: 4 }}>
            ...
            <div className="user-details">
              ...
              {profile.linkedIn && (
                <div className="link-coding">
                  <Link to={profile.linkedIn} target="_blank" rel="noopener noreferrer" className="linked">
                    <img src={linkedIn} alt="github" width={'20px'} height={'20px'} />
                    {profile.lastName.length > 6 ? (
                      <p>{profile.firstName?.toLowerCase()}_</p>
                    ) : (
                      <>
              ...
              <div className="edu-section">
                ...
                <div className="clg-section-1">
                  ...
                  <div className="info-2">
                    <div className="year">
                      <p>{formatDateForDisplay(education.startYear1)} to {formatDateForDisplay(education.endYear1)}</p>
                ...
                <div className="clg-section-2">
                  ...
                  <div className="info-2">
                    <div className="year">
                      <p>{formatDateForDisplay(education.startYear2)} to {formatDateForDisplay(education.endYear2)}</p>
                    </div>
                    <div className="cgpa">
                ...
                <div className="clg-section-3">
                  ...
                  <div className="info-2">
                    <div className="year">
                      <p>{formatDateForDisplay(education.startYear3)} to {formatDateForDisplay(education.endYear3)}</p>
