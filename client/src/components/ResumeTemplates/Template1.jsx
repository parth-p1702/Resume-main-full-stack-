                  ...
                  <div className="info">
                    ...
                    <div className="clg-details">
                      <div className="clg-degree">
                        {education.year} in {education.branch} 
                        
                      </div>
                      <div className="meta-data">
                        <div className="dates">
                          <i className="fa-solid fa-calendar" />
                          {formatDateForDisplay(education.startYear1)} to{" "}
                          {formatDateForDisplay(education.endYear1)}
                        </div>
                  ...
                  <div className="info">
                    ...
                    <div className="clg-details">
                      <div className="meta-data">
                        <div className="dates">
                          <i className="fa-solid fa-calendar" />
                          {formatDateForDisplay(education.startYear2)} to{" "}
                          {formatDateForDisplay(education.endYear2)}
                        </div>
                        <div className="locality">
                          <i className="fa-solid fa-map-marker" />
                          {education.city2}
                  ...
                  <div className="info">
                    ...
                    <div className="school-details">
                      <div className="meta-data">
                        <div className="dates">
                          <i className="fa-solid fa-calendar" />
                          {formatDateForDisplay(education.startYear3)} to {formatDateForDisplay(education.endYear3)}
                        </div>
                        <div className="locality">
                          <i className="fa-solid fa-map-marker" />
                          {education.city3}
